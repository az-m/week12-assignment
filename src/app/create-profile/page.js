...
export default function CreateProfile() {
  ...
  async function handleSubmit(formData) {
    ...
    db.query(
      `INSERT INTO student (first_name,family_name,form_id,house_id,clerk_id) VALUES ($1, $2, $3)`,
      [formData.first_name, formData.family_name, formData.form_id, formData.house_id, userId]
    );
